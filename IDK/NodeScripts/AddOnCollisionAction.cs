...
namespace IDK.NodeScripts
{
    public class AddOnCollisionAction : IBehaviorNode
    {
        ...
        public void OnCollisionEnterEvent(Collision other, SavedNode savedNode,Unit unit, NodeRunner nodeRunner)
        {
            ValuePool valuePool = savedNode.GetValuePool(unit);
        ...
        public void RunAction(NodeRunner nodeRunner, SavedNode savedNode, ProjectileHit projectileHit)
        {

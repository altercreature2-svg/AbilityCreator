...
{
    public class CreateObjectVariableNode : IValueNode
    {
        public IEnumerator<CoroutineReturn> Cache(NodeEnv env)
        {
            ...
            {
                objectStorer.store.Add(name, new ObjectVariable());
            }
            
            env.AddValue(NodeBlueprint.ConnectionClass.GiveGameObject, objectStorer.store[name] as ObjectVariable);
            return null;
        }
